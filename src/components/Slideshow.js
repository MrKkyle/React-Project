...
function Slideshow(props) 
{
    ...
    [   
        ...
        {id: 9, weapon_description: "A gentle swing in the chaotic abyss will stir up a tempest that affects everyone's fate.", weapon_img: weapon9, character_description: "completed3", character_img: simulacra9 },
