...
VALUES (
"Equipment are items that can be equipped to boost certain stats of the Wanderer. Equipment comes in all rarities.<br><br>Each piece of Equipment can have 2 or 3 fixed base stats based on their type, and 2-4 random substats.<br><br>Every current piece of gear can have any substat, except for Crit, which can only appear as a substat on Gloves and Boots pieces.", 
"<u>Break from Destiny:</u><br> In Break from Destiny, players can participate in Break from Destiny seasons to compete against up to 30 Wanderers in a 'battle royale' - like format, and the last remaining Wanderer will win the game.<br><u>Critical Abyss:</u><br> In The Critical Abyss, players can participate in Team 8v8s to obtain the currency Critical Point, which can be used to redeem items in the Points Store.<br> <u>Apex League:</u> <br> In the Apex League,players can compete and fight against other player to rank up on a server-wide leaderboard and acquire leaderboard rewards", 
