...
"Enemies  are hostile creatures in Tower of Fantasy that can be defeated by players. There are several different types of enemies classified by overall ascending difficulty: Lesser Enemies, Elite Enemies, Boss Enemies and World Bosses. Side note: Lesser and Elite enemies can take fall damage. Lesser Enemies are the most common type of enemy which can be easily found across the world. They include: •Bears•Beaters•Wild Boars•Bunnydarts •Densyas•Elemental Cores •Headhunter Elites •Head Hunters •Hyena Destroyers •Hyena Elites •Hyena Warriors •Ravager Assaulters •Ravager Assaulter Elites•Ravager Flyers•Razor Elites •Watchers", 
"Hykros is a faction that primarily operates in Aesperia. They are a scientific research and administration institution located on the top floor of the Aesperia Tower of Fantasy. Hykros researches and continues to pursue the applications and use of Omnium as they believe that for the sake and future of all Aidans, Omnium can one day be controlled to serve the people.Following the Cataclysm and its disastrous aftereffects, Hykros began prioritizing research and development on Suppressors, which would be used to resist the severe radioactive fallout that plagued the planet.", 
"Warren Snowfield is a region in Aesperia consisting of the Saag passage, Aarniel Fortress, Silvercrown Forest and theSouthern Naa Fjords. The Saag passage is a small valley among the snow mountains, which twists and turns like a passage in mother nature's yard. The abandoned buildings and machinery along the fjords have revealed their glorious past as a bustling trade dock. ", 
"World Bosses are powerful bosses that can be found in the world of Tower of Fantasy. World Bosses are unique bosses that can be found in the regions of Aesperia and Vera, with one World Boss generally being positioned in a single regionWorld Bosses that can be found in Aesperia include: •Robarg•Apophis •Frost Bot •Lucia •Sobek •Barbarossa •Devourer •Interdimensional Frostfire Dragon
");

INSERT INTO vera (confoundingAbyss, graySpace, innars, miasmicSwamp, mirroria, twilightZone, veraEnemies, veraWorldBosses)
VALUES ("The Confounding Abyss is an area in Vera and is physically located beneath the Mirroria. The Confounding Abyss appears immediately when the construction team of the Third City lost 
